...
const navItems = [
  ...
  { href: '/client/invoices',  label: 'My Invoices', icon: FileText },
];
    ...
    ">
      ...
      <div className="px-6 py-6 border-b border-vault-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-vault-muted text-[10px] tracking-widest uppercase">Client Portal</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-b border-vault-border">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-8 h-8 bg-vault-blue rounded-full flex items-center justify-center shadow-glow">
